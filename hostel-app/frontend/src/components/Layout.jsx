...
import {
  Compass, LayoutDashboard, CalendarCheck, Users, DoorOpen,
...
const navItems = [
  ...
  { to: '/hospedes', icon: Users, label: 'Hóspedes' },
  { to: '/quartos', icon: DoorOpen, label: 'Quartos' },
]
      ...
      <aside className="w-64 shrink-0 flex flex-col glass border-r border-white/5 relative z-20">
        ...
        <div className="px-6 py-7 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display font-bold text-white text-sm leading-none">HostelApp</p>
              <p className="text-slate-500 text-xs mt-0.5">Gestão de Hospedagem</p>
            </div>
          </div>
        </div>
